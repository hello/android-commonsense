...
public final class StringRef implements Serializable, Parcelable {
     ...
     */
    private final @Nullable ArrayList<Serializable> formatArgs;
     ...
     */
    public static StringRef from(@StringRes int formatRes, @NonNull Serializable... rawFormatArgs) {
        final ArrayList<Serializable> formatArgs = new ArrayList<>(rawFormatArgs.length);
        Collections.addAll(formatArgs, rawFormatArgs);
    ...
    private StringRef(@StringRes int stringRes,
                      @Nullable ArrayList<Serializable> formatArgs,
    ...
    public static final Creator<StringRef> CREATOR = new Creator<StringRef>() {
        ...
        public StringRef createFromParcel(Parcel source) {
            return new StringRef(source.readInt(),
                    (ArrayList<Serializable>) source.readSerializable(),
                    source.readString());
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeSerializable(formatArgs);
    ...
    public String resolve(@NonNull Context context) {
        if (stringRes > 0) {
            if (formatArgs != null) {
                return context.getString(stringRes, (Object[]) formatArgs.toArray());
            } else {
    ...
    public boolean equals(Object o) {
        ...
        return stringRes == stringRef.stringRes &&
                !(formatArgs != null ? !formatArgs.equals(stringRef.formatArgs) : stringRef.formatArgs != null) &&
    ...
    public int hashCode() {
        ...
        result = 31 * result + (formatArgs != null ? formatArgs.hashCode() : 0);
